...
class CollatzMember():
    ...
    def __init__(self, value, bit_array = bitarray(''), one_child = None, zero_child = None, parent = None) -> None:
        self.__value = value
    ...
    @property
    def bit_array(self):
        return self.__bit_array.decode(CollatzMember.__D)
    ...
    def __str__(self) -> str:
        return("CollatzMember:\n"
               ...
               f"\tBitarray: {self.__bit_array}\n"
               f"\tOne Child: {self.__one_child}\n"
               f"\tZero Child: {self.__zero_child}\n"
